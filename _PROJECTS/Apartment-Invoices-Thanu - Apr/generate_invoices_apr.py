#!/usr/bin/env python3
"""
Invoice Generator for Krish Lee Holiday Services - April 2026
"""
...
TAX_RATE = 0.09
INVOICE_DATE = "30/04/26"  # Last day of April 2026
...
def main():
    ...
    excel_path = os.path.join(script_dir, "April Accounting Report.xlsx")

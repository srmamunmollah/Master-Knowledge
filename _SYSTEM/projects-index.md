...
## Active Projects - Steve Rogers (SR)
...
| Mein-Erstes-Projekt | New | - | Your first real project | `Mein-Erstes-Projekt - SR/` |

---

## How to Add a New Project

1. Create folder: `_PROJECTS/Projectname - SR/`
2. Create `CONTEXT.md` inside the folder
